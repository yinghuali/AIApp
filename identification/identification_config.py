class Config:
    def __init__(self):
        ...
        self.list_dl_framework = ['TensorFlow', 'TfLite', 'NCNN', 'Caffe', 'Caffe2', 'DeepLearning4j', 'Snpe',
                                  'MxNet', 'Mace', 'FeatherCNN', 'Xnn', 'CNNDroid', 'CoreML', 'Chainer',
                                  'Pytorch', 'PaddlePaddle', 'Keras', 'Neuroph', 'TVM', 'OpenCV', 'CNTK']
        ...
        self.current_path = '/Users/yinghua.li/Documents/Pycharm/AIApps/identification'
        self.path_result = '/Users/yinghua.li/Documents/Pycharm/AIApps/result.txt'

        self.path_input_apk = '/Users/yinghua.li/Documents/Pycharm/data/3.pkl'
        self.number_single_sha256 = 17860
        self.number_pool = 1
